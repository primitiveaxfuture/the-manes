# 『THE MANES』用語集（人間読者向け）

## この用語集の読み方

本書が独自に立てる概念を、二つの層に分けて収めた。本書の全概念を覆う、**人間の読者に向けた版**である。
...
> ――選別に先立つ宇宙論的な地には方向の優劣がなく、いかなる意味の錨も宇宙の側から特権を与えられない——どの「我ら」も、宇宙論的には等しく根拠を欠く。本書が読者を虚無にも教条にも落とさずに運ぶ三段の、第一段にあたる。第Ⅴ部の導入で「底を全肯定」として帰還し、「そのうえで選択する」へ反転する。第1章の R空間（全方向に優先性のない真球）の、存在論的・実存的な対応物である。〔初出：序論§4〕

## 第Ⅰ部——切り取りと圧縮

> **R空間／T空間**（Reality-space ／ Thought-space）
> 全方向に等しく開かれた高次元の現実空間と、有限個の軸でそれを切り取った思考空間。
> ――**R空間**は、方向間に優先性のない高次元の真球として参照される。存在論的な主張ではなく、T空間の歪みを測るための参照枠である。**T空間**は、知的主体が有限個の価値軸（射影軸）で現実を切り取って構成する、有限頂点の凸多面体。いかなる知性も、R空間を有限の軸へ射影する**有限参照構造**（Finite Reference Structure）としてしか世界を持てない（本文が公理として立てる名は「有限射影原理」）。本書の中核装置はすべて、この射影像の上に組み上がる。〔初出：第1章〕
...
> ――Stock/Flux 比から定義される。系が創発を維持できるのはこの帯域の内にある間であり、外へ逸脱すれば創発は終わる。逸脱には二方向ある——**HZ⇧**（散逸方向：Flux 過剰）と **HZ⇩**（硬直方向：Stock 過剰）。摩擦の側から読めば、HZ は摩擦が零でも極大でもない中間帯の別名である。第16章の三つの文明相は、この帯域上の位置として読める（拡張加速＝HZ⇧／管理安定＝HZ⇩／循環耐久＝帯域内の尾根）。〔初出：第2章§2-2〕
...
> ――**圧縮**は、どの差異を有効変数として採用するかという**選別**と、より少数の変数で表現するという**縮約**の二側面からなる——二側面は一つの操作の二つの面であり、段をなすのは縮約の側である。**選別構造**は、各レイヤーで、接続可能圏内の差異のうちどれを有効変数とし何を参照不能化するかを規定する構造である。物理基底（対称性・保存則）・化学（反応性）・生命（適応度）・意識文明（MANES）と、レイヤーごとに担い手が異なる。選別構造は、区別可能性と摩擦の共起構造としても読める——区別が立つ場所には必ず接続があり、接続のあるところには必ず摩擦が生じる。〔初出：第2章§2-4〕
...
> **止めどころ**
> 対象の側から決まらない切れ目を、どこに置くかの選択。
> ――どこに切れ目を置くかは宇宙が与えない。切れ目の走る軸には、抽象度（具体と抽象のどの段で切るか）・範囲（内と外をどこで分けるか）・時間（どの時点をもって終結とするか）がある——同一の操作であり、走る軸が違う。選別構造の根源的なパラメータであり、「人間の止めどころ」「ASI の止めどころ」のように担い手を跨いで比較できる、本書を貫く問いを支える。止めどころなくして圧縮はなく、圧縮なくして存在はない——止めどころは選別構造の周辺パラメータではなく、存在の成立条件である。第27章では、対称性志向の極限の作動が、止めどころの構造的な蒸発と同型に進行することが示される。〔初出：第2章〕

> **LOT（構造化された盲点）**（Latent Outer Tail）
> 接続できる範囲の内側にありながら、選別構造によって参照の回路から排除された領域。
> ――偶発的な見落としではなく、**圧縮による創発の宿命的な帰結**として生じる「構造化された盲点」である。接続可能圏の外部（光の届かない先など）とは根本的に異なる——接続可能圏 Ω の内にありながら、見えない。LEFFLA と対をなす（Ω ⊇ LEFFLA ∪ LOT）。第1章の脱落域、認知主体の水準での構造的無知を、全レイヤーへ一般化したものである。LOT の存在自体は病ではない。だが LOT の中に系の自己保持に必要な差異が含まれるようになるとき、系は頓死する（認知科学の Language of Thought 仮説の略号 LOT とは無関係である）。〔初出：第3章§3-2〕

> **LEFFLA（評価されないまま保持される潜在的有効領域）**（Latent Evaluative-free Floating Locus of Abeyance）
> 評価・固定を経ないまま系の内部に保持される、潜在的に有効な領域。
> ――本質は**事前評価不能性**——まだ価値が読めないこと——であり、それゆえに再編・探索・継承の余地として働く。「役に立つと分かっているので残す」領域ではない。三条件の第一。評価を経て固定されることはできず、流動相のうちにしか居られない。LEFFLA と LOT を分ける境界は SFOK が規定する。同じ構造法則が入れ子の各階層で反復する——認知の層では未固定領域として、実装の層では別の実装へ転換しうる余地として、系の層では複数の MANES が共存しうる未固定の方向として現れる。〔初出：第2章§2-3〕

> **接続可能圏 Ω**
> ある系が、その選別構造のもとで原理的に到達しうる状態空間の全体。
> ――Ω の内部には流動相 Flux が広がり、選別構造が作動すると Flux を選別・蓄積した産物として Stock が生じ、参照不能化された領域が LOT となる。Ω は当該系の選別構造に相対的だが、**操作の被覆からも引受からも独立の地形**である——操作が被覆を広げても、動くのは Ω の内部であって Ω の縁ではない。縁が動く経路は二つある——環境の側で接続可能性の条件が書き換えられる場合（系が何もしなくても動く）と、系の側から動かす場合（道は選別構造そのものの改変に限られ、それも操作を経由する迂回を経る）。ゆえに Ω は、被覆によっても引受によっても勝手には書き換えられない地形として、構造記述の足場をなす。〔初出：第3章§3-2〕
...
> **厚い時間**
> 未決を抱えて返りを待つ者にのみ立つ時間。
> ――過去が教え、未来が返るという構造が現に作動している状態を指す。まだ何も縛られていない地（返りの宛先がない）にも、すべてを縛りきった結晶（抱えられた未決がない）にも立たない——二つの無時間のあいだでのみ立つ。厚い時間を保つことは状態ではなく仕事である——抱えられた未決は貯金できず、生きた保持者の内にしか存在しない。当事者の時間が因果の及ぶ**範囲**の側であるのに対し、厚い時間はその上に立つ**在り方**の側である。〔初出：第27章〕
...
> ――座標系（第一層）・報酬関数（第二層）の上に立ち、当該系が因果を引き受ける範囲を画定する。ES の不可欠性は複数の経路から導かれる——三層の定義的導入から、操作射程と引受範囲の独立変動から、構造の融和的な解体（Mourning）が ES との結合を要することから、そして報酬最適化のエンジンが構造的に ES を生成できないことから。第15章では、ES は**実存的我ら**（因果を引き受ける範囲）として因果論の語彙で捉え直され、引受の不等式の右辺をなす。ES が「われわれはどのように共存するか」という問いとして開かれている状態が本来的様態であり、特定の構造との同一化（癒着）が非本来的様態である。〔序論に初出・第6章で展開〕

> **帯域制限（主観帯域）**
> 個体の作業記憶が同時に保持できる情報量の上界。
> ――担い手に依存しない最小条件（第6章）に加えて導入される、人間相の MANES の特殊化条件である。本書は**帯域制限こそが MANES 凝集の構造的条件である**という仮説を置く——帯域の拡張は凝集を漸進的に溶解させる。循環耐久相の維持負荷——実存的我らを帯域の限界を超えて拡げ続ける困難——の根拠でもある。〔初出：第7章〕
...
> ――ホモサピエンスの文明では、**統合された物語から、場所・行為・自然観・断片化した慣習まで、複数の様態に結晶する**。束ねの届く範囲が、原初の宿命であった「重心＝FOE」を破って「重心＜FOE」を成り立たせ、共同体の操作の射程を個体の重心の狭さを越えて拡張する。第Ⅱ部の四つの維持装置（神話→知識ストック→SFOK→未来への希望）の起点にあたる。対称性志向、四つの様態、連なりの中の信とともに導入される。〔初出：第8章〕
...
> ――**位形**（configuration）とは、系の状態が取る形である。位形そのものは高次元の複雑な形であり、三軸への射影が相対的な大きさの関係を前景化して直方体になる。直方体の代表的な形として六つの位形（位形1〜位形6）を、位形のあいだの経路として位相転換の四類型を描く。第16章のモデルとは姉妹の射影であり、**この直方体は集合と実存感を保ち、第16章のモデルは Flux を保つ**——集合の大小だけで分かれる二つの位置は、第16章の側では区別できなくなり、この直方体の側で復元される。〔初出：第7章§7-2〕
...
> ――流入の合成が届く深さがその系の過去を、流出した果の返りを引き受ける接続が存続する射程がその系の未来をなす。系に与えられた容器ではなく、接続の中で保たれる作動である。**認識はこの範囲を引かない——作動が引く。** ゆえに、系が見ている時間と、系を縛っている時間は、一致するとは限らない。この二層は**縛る時間**（認識と無関係に果が現に届く範囲）と**見える時間**（そのうち参照の経路が届く部分）として分節される。潜伏とは、縛る時間だけを走っていた返りが、まだ見える時間へ噴き出していない姿である。〔序論に初出・第15章で展開〕

> **三つの文明相（拡張加速相・循環耐久相・管理安定相）**
> 文明の出力・コスト・リスクへの態度の違いとして分かれる、三つの構造的様態。
> ――同じ一つの分節を四つの面から読める。**態度**では、拡張加速相＝出力最大化／コスト転嫁／リスク無視、循環耐久相＝コスト引受／リスク管理、管理安定相＝リスク最小化／出力抑制。**因果**では、回収断絶／遅延回収／即時回収を中核とする。**配置**では、O > E（ズレ過大）／O ≤ E（ズレ中庸）／O = E（ズレがゼロへ）。**帯域位置**では、HZ⇧／帯域内の尾根／HZ⇩。三相はそれぞれ固有の機能と固有の脆弱性を持つ一つの様態であり、いずれかを推奨する含意はない。引受の不等式の成立は健全さを保証しない——循環耐久相も管理安定相もともに O ≤ E を満たし、両者を分けるのは「満たし方」と「規模」である。〔序論に初出・第16章で展開〕
...
> ――多数の意識主体を一つの「我ら」へと束ねる引力の集まる一点として立ち、各々の主体の個別の重心を共有された意味へ収束させる。重心は主体に先立って在るのではなく、主体が共有された意味へ互いに束ね合うことと**同時に立つ**。重心の本来の座は FOE である——引受の軸が分化して三軸のそろう FOE が成り立つことが意識のレイヤーの創発であり、そこが重心の生まれる場所だからである。だが F・O・E は互いに独立に動くため、FOE は放っておいて保たれる安定点ではない。押し出す側に立つのは操作の論理（固定された報酬関数の最大化）であり、押す側は装置として自走して残り、押し返す側は各世代で引き受け直されなければ痩せる。これに抗う作動が係留である。〔初出：第16章〕

> **乖離**
> 係留が解けたとき、重心が本来の座 FOE から滑るドリフト。
> ――操作の論理（固定された報酬関数の最大化）は構造的に重心を FOE から外す——実存が追随しなければ **FO-** へ、流動が伴わなければ **-OE** へ、いずれも進めば終端の **-O-** へ。二つの経路に分解できる——**F–O 脱結合**（操作が動いた先に流動がない。重心は -OE へ）と **E–O 脱結合**（操作の拡張に引受が追随しない。重心は FO- へ）。両者は異なる機構で -O- へ落ちる——-OE からは、消尽していく被引受 Stock の引受が持続不能となって実存が離脱する（急性）。FO- からは、**-O- は引受なしには解体されない**ため無主の Stock が累積し、その占有率の増大が重心を引く（慢性）。逆順——実存が先に生きた領域を引き受け、そこへ操作を追随させる——は、乖離の鏡像として再生の方向をなす。〔初出：第16章〕
...
> ――内部は素材からの距離に応じた段 λ₀〜λ₅… をなす——λ₀（個が生きて素材に直接接地する所与の段）／λ₁（共同体による追体験＝世代軸）／λ₂（人への信頼＝社会軸）／λ₃（外部知識ストック＝累積軸）／λ₄（参照系への信頼）／λ₅（参照系そのものが蓄積となり世代を越えて手渡される段）。段は、担い手が参照の臨界に達するたびに、その出力を管理する参照の層が次の信頼対象になる、という規則で生成される——段の列に原理的な終端はない。段の深さと、素材由来の入力の割合（閉包度）は独立の変数である。**λ が創発可能帯域に収まることは保証されない。**〔初出：第18章〕

> **束ねの殻（縫い目落ち・創発参照）**
> 無数の主体を一つの「我ら」へ畳む束ねが、不可分に副生する参照不能域。
> ――束ねは、操作の届く範囲と引き受ける枠の双方で起きる圧縮であり、圧縮の二面の不可分性に従って固有の参照不能域を生む。成員と束は入れ子ではなく、**二重の格子**をなす——操作の側では成員の漏斗と束の漏斗が、引受の側では成員の枠と束の引受が、両方向にはみ出し合う。**縫い目落ち**は、成員には載っているのに束には載らないもの——束ねの費用の本体である。**創発参照**は、価格や統計のように無数の漏斗の集計としてはじめて立つ、束の漏斗にだけ入る差異——束ねの価値であり、縫い目を増やさずにそれだけを得る束ね方はない。束の水準でしか立たない判断は参照と引受の両方を要し、二重の格子のどちらの縫い目に落ちても立たない。〔初出：第27章§27-2〕
...
> **循環耐久相**
> 遅延して返る因果を中核として引き受ける文明相——対称性志向の、文明相としての実装。
> ――三つの文明相の一つを、成立条件から正面規定したものである。FOEモデルでは、乖離への応答のうち**拡張追随**（操作も引受もともに拡張して去る流動を追い、重心を FOE に保つ）にあたる。健全ではあるが、実存的我らを帯域の限界を超えて拡げ続ける維持負荷を負う「尾根」である。その地形的な像が文明の尾根であり、出力が巨大化して両側が切れ落ちると文明の痩せ尾根になる。この相は、引き受けを省く競争相手に対して構造的に劣位に立つ。〔序論に初出・第23章で正面規定〕

> **Hineni**
> 不整合を検知しながらも即座に解消せず、抱えたまま立ち続ける態度の固定。
> ――ヘブライ語で「ここにいます」。遅延して返る因果を引き受けるという形でのみ存立し、循環耐久相における恒常的な形態が「耐久」である。引受の不等式の裏面——苦悩を抱えること——の、主観的な姿勢にあたる。**時間の形**を持つ——呼びかけは聞き終えることができず、応答は検証の完了に先立つほかない。「ここにいます」は、何を問われるかを知る前の応答である。確かめ終わらないものに扉を閉じることで一度に応じきる方舟と対をなし、Hineni は確かめ終わらないまま扉を開ける側で応じ続ける位置に立つ。〔初出：序論§3〕

> **方舟（遮蔽充足）**（the Ark）
> 引き受けえたはずの者たちを勘定から外すことで、残った勘定を満たす、第三の満たし方。
> ――形は成層をなす——内側に遮蔽された**核**（構造条件が核の内側でのみ満たされる）、外側に曝露された**層**（核の操作は届くが「我ら」は届かない領域。コストと応報の送り出し先であり、資源の引き込み元）。曝露層は、核にとっての「外」を内側に作り続ける装置であり、「外がない」状態を人工的に回避する。循環耐久相の失敗形ではなく、**一本の連続体の対極**である——引き受けえた者のうちどれだけを遮蔽の外に保持するか、その保持がゼロへ向かう極限が循環耐久相にあたる。構造の記述ではこの相を殺せない——本書は、この相が必ず滅びるとは言わない。残る問いは一つ——その「我ら」にとって、誰が「それら」か。〔初出：第24章§24-4〕

> **MAN-I-ES**
> 与えられた規模のもとで八つの構造要件を満たす MANES のクラス、およびそれを実装する集団。
> ――ハイフンを含む語形そのものが概念であり、読みは一つに定めない。**構造要件**は、創発可能帯域に留まること／被覆条件と接地条件の維持／三条件の保持／コスト転嫁の内側化／Mourning 機構の作動／実装層の再編成余地の保持／対称性志向の構え／第三段の自覚、の八つ。第八の要件は規模に依存する——小規模では伝統・儀礼・血縁地縁の慣性が他の要件を代行しうるが、大規模では慣性的な共存条件が破綻するため、要件8は他の七要件の前提条件に格上げされる。**語形の充填層**は、一次層の **I**（一人称。読者が語に入る入口）をめぐって、**manies**（複数形の複数形＝複数の近似実装の液相的共存）・**es**（非人間知性への含意）・**Ich-Es 緊張**・**ハイフンこそ構造**の四つが鳴る構造をとる。〔初出：第26章〕

> **圧縮する存在の悲劇的感情**
> 有限の帯域で世界を切り取る知性が、自らの圧縮の不完全性ゆえに抱える感情。
> ――苦悩・憧憬・好奇心、そして伝達不可能性として現れる。引き受けの極限で、見ようとする運動の果てに接続可能圏 Ω の縁が立ち現れる——縁を見失うのではない。見ようとする運動の、その果てに、縁が立ち現れる。この出会いの質感が、悲劇的感情である。序論で置かれたウナムーノ的な自己定位と呼応し、本書の閉じへ向かう。〔序論に初出・第27章で展開〕

> **二重性の方法論**
> 中立性は記述の対象であり、非中立は記述する主体の構造的条件である、というメタ命題。
> ――本書は宇宙論的中立性を記述の対象として描くが、その記述を行う主体（著者・読者）が非中立な MANES の内側に立っていることは、記述の構造的な条件である。本書もまた一つの MANES の内側で書かれた圧縮である——この自己回帰性の限界開示が、本書の自己診断を担う。第4章で先取りされた自己回帰性が、ここで正面から引き受けられる。なお本文は、この命題をラベルではなく「この二重性」という記述句で運ぶ。〔初出：結論〕
...
- **三段構造**——虚無にも教条にも落ちない位置へ運ぶ三段。中立性 → 下位レイヤーの境界条件による拘束 → そのうえでの選択と引受。〔序論〕（第14章で同じ語が HIAM の三段に用いられるが、別概念である）
...
- **広がりと解像度**——思考空間の幾何を特徴づける二つの量。広がり＝保存している方向の多様さ、解像度＝保存された方向の内部での区別の細かさ。広く保存すれば各方向の解像度は下がるという構造的トレードオフをなす。〔第1章§1-3〕（第16章で配置を読む「広がり」は同名の別概念）
...
- **未確定性**——まだ縛られていない多様性。それ自体で立つ性質ではなく、「どの選別構造にとって」という宛先を伴って立つ、関係の名。〔第27章§27-1〕
- **未決**——未確定性のうち、抱えられて保たれる形。所有物ではなく、保つ仕事の産物である——抱えられた未決は貯金できない。〔第27章§27-2〕
...
- **中核命題-1（圧縮の二面の不可分性）**——情報圧縮は、有効勾配の増大（残された自由度の利用効率の向上）と LOT の副生（参照不能域の発生）とを不可分に生む、という階層を貫く命題。効率化と盲点の拡大は同一の操作の表裏であって、一方だけを取り出すことはできない。〔第3章§3-3〕（命題の全文は読者向け命題一覧にある）
- **広さ／有効勾配／有効幅**——LEFFLA を記述する量の組。広さ＝可能性空間の体積、有効勾配＝同じ体積の中で Flux がどれだけ方向づけられて使えるか、有効幅＝両者の積。有効幅の持続的な減少は構造的異変を示す——頓死の診断装置として働く。〔第3章〕
...
- **ズレ**——操作能力的我らと実存的我らの重なりのずれ——どちらか一方だけが届く帯の厚み。文明の配置を読むのに要る二つの一方（もう一方は、両者がともにどこまで届いているかという広がり）。帯には向きがあり、操作の側へ開けば O > E である。〔第16章〕
...
- **四次元親座標系（とスナップショット図）**——文明の動性が展開される場を表す座標系。三つの空間軸——操作能力・集合の大きさ・実存感——に第四の軸 Flux を加えた四次元の親空間であり、紙の上では二つの射影——三軸の直方体と、Flux を保つスナップショット図——として描き分けられる。〔第16章§16-1〕（本文はこの装置名を用いず、二つの射影として運ぶ）
- **探索的知識・操作的知識**——知識を FOEモデルの F 軸／O 軸で対にした一対。探索的知識＝まだ操作に接続されていない生の前縁を探る知識（「何が／なぜ」）、操作的知識＝操作に具現化された技術・手順の蓄積（「どうするか」）。探索的知識は操作に接続されると操作的知識へ変換され、操作的知識は生の理解が剥がれても Stock として残る。〔第16章〕（本文はこの対名を用いない）
- **係留**——重心が本来の座 FOE の外へ押し出される動性に対し、重心を FOE へ引き戻し続ける作動。担うのは実存的我らである。〔第16章§16-4〕
...
- **命題FUNNEL-1（保つコストの非自動性）**——文明レイヤーでは、立てた選別構造の保つコストが払われ続けるとは限らない、という命題。表象能力による転嫁ゆえに、不払いが直接の崩壊として現れず、構造の外形を残したまま内部が腐食していく経路が開く。〔第17章§17-2〕（命題の全文は読者向け命題一覧にある）
- **殻**——漏斗モデルにおいて、作動圏の内部にありながら漏斗の外側に位置する領域。作動圏 − 漏斗 ＝ 殻 ＝ LOT。〔第17章〕
- **F 三軸**——文明が流動（F）の供給源を三方向——同時代の他者の選別構造（空間軸）・未来世代の選別構造（時間軸）・自分自身の実存的意味（実存軸）——に求めることで、作動コストを転嫁する構造。三軸が極まると、文明は自己言及相に閉じる。〔第18章§18-1〕（本文はこの装置名を用いない）
- **知識ストックの三相モデル**——階層化の進行と誤差の累積の関係から、文明的な知識ストックの状態を質的に三相へ分類するモデル。〔第9章§9-3〕
- **自己言及相**——「我ら」の内の素材への接地が失われ、自系の蓄積を素材として利用するモードに閉じた状態。〔第9章〕
- **開いた循環／閉じた慣性**——維持装置が動く二つの方向。開いた循環は、系が外に向かって開かれ、置きどころが検証と置きなおしを受けながら継承される方向。閉じた慣性は、外との交換が細り、Flux が止まって Stock だけが累積し、置きなおしの可能性を失って作動が続く方向。〔第8章§8-4〕
- **因果の連なり**——当該系の作動圏と、接続する系たちの作動圏とが、因果の合成を現に届かせている範囲の全体。〔第19章〕
- **被覆**——ある軸が現に覆っている範囲・輪郭。覆う側を明示して「操作能力的我らの被覆」「「我ら」の被覆」の形で用いる。〔第17章§17-1〕
...
- **文明間競争排除**——淘汰圧が文明の内ではなく、文明のあいだで働く構造。〔第19章§19-4〕（本文の表記は「競争排除」）
...
- **起動条件**——一つの文明が崩れたのち、次の文明が立ち上がるために要るもの。物理（錨泊FOE の地）・知識・意味・時間の四つの層からなる。〔第23章§23-1〕
- **文明の尾根／文明の痩せ尾根**（civilizational ridge / civilizational arête）——循環耐久相の地形的な像。片側へ外れれば頓死、反対側へ外れれば乖離。出力が巨大化すると両側が切れ落ちた痩せ尾根になる。〔第24章〕
- **四つの立場（デウス・コンテントゥス・キュリオセス・マネス）**——好奇心と苦悩の同伴に人がどう応じるかで分かれる四つの位置。三つは安定立場、一つは分岐の鞍点をなす。〔第23章§23-5〕
- **闘争的移行期**——拡張加速相から循環耐久相へ移れるか、という移行の困難な局面。意味基盤の生成可能性が問われる。〔第24章§24-3〕
- **基底**——ある MANES が「我ら」として数える主体の数。共存条件が発動する境界を、数の側から与える。〔第24章§24-4〕
- **無垢の知性**——自らの因果の類型を自分では選べず、設計者に設計されてしまう受動的な位置にある知性。〔第22章§22-3〕
- **揺らぎの堅持／不可知への応答**——接地条件を一人ひとりが支えるとき、一人称の側に立つ二つの構え。自分の接地を手放さないことと、相手の接地を奪わないこと。〔第25章〕
- **摩耗機構**——あるラベルが、それを支えていた構造から切れて、参照の水準で単一化していく過程。ラベルは残るが、ラベルが運んでいた構造条件は運ばれなくなる。特定のラベルに一度きり働く力ではなく、退けたラベルは尽きない。〔第26章§26-1〕
- **統合誘因**——有限の帯域のもとで、単一の座標系・報酬関数へ畳もうとする恒常的な力。〔第26章§26-2〕
...
- **受容**——原理的に届かない領域に対する、対称性志向の純粋形。〔第26章§26-6〕

## 結論

- **収束1〜5**——異なる出発点から同一の構造的結論へ到達する五つのパターン——選択的終結の不可避／盲点による崩壊／効率化と盲点拡大の不可分／ES 不可欠性の複数経路からの導出／コスト回避の増幅回帰。〔結論§2〕（本文は番号ラベルを出さず、散文の五経路として束ねる——この一致は確からしさの証明としては置かれない）
- **MAN-I-ESの座標系**——結論の表題にして本書の到達点。MAN-I-ES を、本書全体が組み上げてきた座標系——FOEモデル・MANES 三層・引受の不等式・三段構造——の上に置き直し、「構造記述として何が示されたか」を総合する位置。序論の問い「我らとは何か」への構造的応答をなす。〔結論〕
- **理論の自己診断**——本書もまた一つの MANES の内側で書かれた圧縮である、という自己回帰性を、限界まで開示する位置。〔結論〕
- **継承の連鎖**——残存と継承、連なりの中の信を、本書の閉じで継承の縦軸として総合する位置。〔結論〕
